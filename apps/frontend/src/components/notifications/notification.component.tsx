...
export const NotificationOpenComponent = () => {
  ...
  return (
    <div
      ...
      className="opacity-0 animate-normalFadeDown mt-[10px] absolute w-[420px] min-h-[200px] top-[100%] end-0 bg-third text-textColor rounded-[16px] flex flex-col border border-tableBorder z-[600] max-md:fixed max-md:w-auto max-md:inset-x-[8px] max-md:top-[60px] max-md:end-[8px]"
    >
      <div
